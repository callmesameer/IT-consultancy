    ...
    <section class="page-banner pt-xs-60 pt-sm-80 overflow-hidden">
        <div class="container">
            <div class="row align-items-center mt-5">
                ...
                <div class="col-md-6">
                    <div class="page-banner__media mt-xs-30 mt-sm-40 mt-55">
                        <img src="assets/img/page-banner/page-banner-start.svg" class="img-fluid start" alt="">
                        <img src="assets/img/banner/17.jpg" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="contact-us__content">
                        ...
                        <div class="description font-la">
                            <p>Connect with our IT consultancy for personalized solutions. Reach out to discuss your technology needs, from strategic planning to implementation. Let's collaborate to enhance your IT capabilities and drive success.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row contact-us__item-wrapper mt-xs-35 mt-sm-40 mt-md-45">
                        <div class="col-sm-6">
                            <div class="contact-us__item mb-40">
                                <div class="contact-us__item-header mb-25 mb-md-20 mb-sm-15 mb-xs-10 d-flex align-items-center">
                                    ...
                                    <h5 class="title color-d_black">America Office</h5>
                                </div>

                                <div class="contact-us__item-body font-la">
                                444 Mustang Draw Trail McKinney Texas 75071
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="contact-us__item mb-40">
                                ...
                                <div class="contact-us__item-body font-la">
                                    <ul>
                                        <li><a href="tell:+214-300-5567">+214-300-5567</a></li>
                        ...
                        <div class="col-sm-6">
                            <div class="contact-us__item mb-40">
                                ...
                                <div class="contact-us__item-body font-la">
                                    <ul>
                                        <li><a href="mailto:hr@alexitsolutions.com">hr@alexitsolutions.com</a></li>
                                        <li><a href="mailto:info@alexitsolutions.com">info@alexitsolutions.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
