                ...
                <div class="row align-items-center">
                    <div class="col-3">
                        <div class="header-logo">
                            <div class="logo">
                                <a href="index.php">
                                    <img src="assets/img/logo/alex.png" alt="logo">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="header-right-socail d-flex justify-content-end align-items-center">
                            <a class="header-contact d-none d-md-flex align-items-center">
                                ...
                                <div class="text">
                                    ...
                                    <h5 class="fw-600 color-white">214-300-5567</h5>
                                </div>
                            </a>

                            <a href="mailto:info@alexitsolution.com" class="header-contact d-none d-md-flex align-items-center">
                                <div class="icon color-yellow">
                                    <i class="icon-email"></i> 
                                </div>
                                <div class="text">
                                    <span class="mb-5 d-block fw-normal color-white">E-mail Us</span>
                                    <h5 class="fw-600 color-white">hr@alexitsolution.com</h5>
                                    <h5 class="fw-600 color-white">info@alexitsolution.com</h5>
                                </div>
                            </a>
                            ...
                            <a class="header-contact d-none d-md-flex align-items-center">
                                ...
                                <div class="text">
                                    ...
                                    <h5 class="fw-600 color-white"> McKinney Texas 75071</h5>
                                </div>
                            </a>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex align-items-center justify-content-between border-top">
                            ...
                            <div class="header-right d-none d-xl-block align-items-center cntscreenr">
                            <a href="contact.php" class="theme-btn btn-sm " data-animation="fadeInUp" data-delay="1.3s">Contact Now <i class="fas fa-long-arrow-alt-right"></i></a>
                                </div>
                ...
                <div class="sidebar-nav__bottom mt-20">
                    <div class="sidebar-nav__bottom-contact-infos mb-20">
                        ...
                        <ul>
                            ...
                            <li><a href="mailto:info@alexitsolution.com"><i class="icon-email"></i>info@alexitsolution.com</a></li>
                            <li>
                                <a  class="header-contact d-flex align-items-center">
                                    ...
                                    <div class="text">
                                        ...
                                        <h5 class="fw-500">214-300-5567</h5>
                                    </div>
                                </a>
                            </li>
                        </ul>
